...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-white overflow-x-hidden">
      {/* Decorative elements */}
      <div className="fixed top-0 left-0 w-full h-1 bg-gradient-to-r from-red-500 via-blue-600 to-red-500 z-50"></div>
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            ...
            className="md:hidden bg-gray-900/95 backdrop-blur-sm text-white border-t border-red-600/20"
          >
            <div className="container mx-auto px-4 py-6 flex flex-col gap-4">
              <button
                onClick={() => scrollToSection("about")}
                className="font-medium capitalize py-3 hover:text-red-500 transition-colors text-left flex justify-between items-center"
              >
                About
              ...
              <Button
                onClick={() => scrollToSection("contact")}
                className="bg-red-600 hover:bg-red-700 text-white w-full mt-2 rounded-full"
              >
                Book Now
              </Button>
            </div>
      ...
      >
        ...
        <div className="absolute inset-0 z-0 opacity-30">
          ...
          <div className="absolute bottom-40 right-10 w-48 h-48 border-2 border-red-600 rounded-full"></div>
          <div className="absolute top-1/3 right-1/4 w-16 h-16 border-2 border-red-600 rounded-full"></div>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-20">
          ...
          >
            <motion.div
              variants={fadeIn}
              className="inline-block px-4 py-2 bg-red-600/20 backdrop-blur-sm rounded-full mb-6"
            >
              <span className="text-red-500 font-semibold">Welcome to</span>
            </motion.div>
            ...
            >
              <span className="text-red-500">{shopData.name}</span>
              <br />
              <span className="text-4xl md:text-6xl">Transform Your Body</span>
            </motion.h1>
            ...
            >
              <div className="flex items-center gap-3 bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full">
                ...
                <span className="text-gray-200">{shopData.location}</span>
              </div>
              <div className="flex items-center gap-3 bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full">
                <Phone className="h-5 w-5 text-red-500" />
                <a href={`tel:${shopData.phone}`} className="text-gray-200 hover:text-red-500 transition-colors">
                  {shopData.phone}
                </a>
              </div>
            </motion.div>
            ...
            >
              <a
                href={`tel:${shopData.phone}`}
                className="bg-red-600 hover:bg-red-700 text-white px-8 py-4 rounded-full transition-all duration-300 flex items-center justify-center gap-2 text-lg font-semibold shadow-lg hover:shadow-red-500/25 hover:scale-105"
              >
              ...
              <button
                onClick={() => scrollToSection("services")}
                className="bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white px-8 py-4 rounded-full transition-all duration-300 text-lg font-semibold border-2 border-white/20 hover:border-red-500 hover:text-red-500"
              >
                Explore Programs
              </button>
            </motion.div>
      ...
      >
        {/* Decorative elements */}
        <div className="absolute -top-20 -right-20 w-64 h-64 rounded-full bg-red-50 opacity-70"></div>
        <div className="absolute -bottom-32 -left-32 w-96 h-96 rounded-full bg-red-50 opacity-70"></div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <motion.div variants={fadeIn} className="text-center mb-12 md:mb-16">
              <span className="inline-block px-3 md:px-4 py-1 bg-red-100 text-red-800 text-xs md:text-sm font-semibold rounded-full mb-4">
                About Us
              </span>
              <h2 className="text-3xl md:text-5xl font-bold mb-4 text-gray-900">
                Building <span className="text-red-600">Strength</span> Since 2010
              </h2>
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
              <motion.div variants={fadeInLeft} className="relative">
                ...
                <div className="absolute -bottom-4 md:-bottom-6 -right-4 md:-right-6 bg-red-600 text-white p-4 md:p-6 rounded-xl shadow-xl">
              ...
              <motion.div variants={fadeInRight} className="space-y-6 md:space-y-8">
                ...
                <div className="space-y-3 md:space-y-4">
                  <div className="flex items-start gap-4 p-5 bg-white rounded-xl shadow-md border-l-4 border-red-600 hover:shadow-lg transition-shadow">
      ...
      <section id="services" className="py-16 md:py-24 bg-gray-900 text-white relative" ref={servicesRef}>
        {/* Decorative elements */}
        <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-red-500 via-blue-600 to-red-500"></div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <motion.div initial="hidden" animate={servicesInView ? "visible" : "hidden"} variants={staggerContainer}>
            <motion.div variants={fadeIn} className="text-center mb-12 md:mb-16">
              <span className="inline-block px-3 md:px-4 py-1 bg-red-600/20 text-red-400 text-xs md:text-sm font-semibold rounded-full mb-4">
                Our Services
              </span>
              <h2 className="text-3xl md:text-5xl font-bold mb-4">
                Premium <span className="text-red-500">Fitness</span> Services
              </h2>
            ...
            <motion.div variants={staggerContainer} className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
              {shopData.servicesList.map((service, index) => (
                <motion.div
                  ...
                  className="bg-gray-800 rounded-2xl overflow-hidden border border-red-600/20 group"
                >
                  ...
                  <div className="p-6">
                    ...
                    <Button
                      onClick={() => scrollToSection("contact")}
                      className="w-full bg-transparent hover:bg-red-600 text-red-500 hover:text-white border border-red-500 hover:border-transparent rounded-full transition-colors group-hover:scale-105"
                    >
                      Book Now
                    </Button>
                  </div>
            ...
            <motion.div variants={fadeIn} className="mt-12 md:mt-20 grid sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
              <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-xl border border-red-600/20">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <motion.div initial="hidden" animate={galleryInView ? "visible" : "hidden"} variants={staggerContainer}>
            <motion.div variants={fadeIn} className="text-center mb-12 md:mb-16">
              ...
              <h2 className="text-3xl md:text-5xl font-bold mb-4 text-gray-900">
                Showcase of Our <span className="text-red-600">Facility</span>
              </h2>
            ...
            <motion.div variants={fadeIn} className="mt-12 md:mt-16 text-center">
              <div className="inline-flex items-center gap-3 md:gap-4 bg-white rounded-full shadow-lg px-4 md:px-6 py-2 md:py-3">
                <div className="flex -space-x-2">
                  {[...Array(3)].map((_, i) => (
                    <div key={i} className="w-6 h-6 md:w-8 md:h-8 rounded-full border-2 border-white bg-red-600 flex items-center justify-center text-white text-xs font-bold">
            ...
            <motion.div variants={fadeIn} className="text-center mt-8 md:mt-12">
              <Button
                onClick={() => scrollToSection("contact")}
                className="bg-red-600 hover:bg-red-700 text-white rounded-full px-6 md:px-8 py-5 md:py-6 text-base md:text-lg group shadow-lg hover:shadow-xl transition-all duration-300"
              >
      ...
      <section className="h-[300px] md:h-[500px] relative">
        <div className="absolute inset-0 bg-gradient-to-b from-blue-600/20 to-transparent z-10"></div>
        <iframe
        ...
        <div className="absolute inset-0 bg-black/30 z-20 flex items-center justify-center">
          <div className="text-center">
            ...
            <Button
              className="bg-red-600 hover:bg-red-700 text-white rounded-full px-8 py-6 text-lg group shadow-lg hover:shadow-xl transition-all duration-300"
            ...
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-red-500">EST. 2010</p>
                </div>
              </div>
                ...
                {["home", "about", "services", "gallery", "contact"].map((item) => (
                  <li key={item}>
                    <button
                      ...
                      className="text-gray-400 hover:text-red-500 transition-colors capitalize flex items-center gap-2 group"
                    >
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href={`tel:${shopData.phone}`} className="hover:text-red-500 transition-colors">
                      {shopData.phone}
                    </a>
                  </div>
                </li>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.9 }}
        onClick={scrollToTop}
        className="fixed bottom-4 md:bottom-8 right-4 md:right-8 z-50 bg-red-600 text-white p-3 md:p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 group"
